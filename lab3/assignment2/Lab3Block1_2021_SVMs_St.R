...
# 2. What is the estimate of the generalization error of the filter 
#    returned to the user? err0, err1, err2 or err3? Why?
# The filter returned to the user is filter2 and err2 is the generalization error
# returned to the user. Generalization error is the result of the model on 
